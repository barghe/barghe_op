...
Spinner::Spinner(QWidget *parent) {
  ...
  comma = new QLabel();
  comma->setPixmap(QPixmap("../assets/img_spinner_comma.png").scaled(screenBG_spinner_size, Qt::KeepAspectRatio, Qt::SmoothTransformation));
  comma->setFixedSize(screenBG_spinner_size);
